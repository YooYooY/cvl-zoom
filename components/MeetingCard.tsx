...
const MeetingCard = ({ icon, title, date, isPreviousMeeting, buttonIcon, handleClick, link, buttonText }: MeetingCardProps) => {
          ...
          {!isPreviousMeeting && (
            <div className="flex gap-2">
              <Button onClick={handleClick} className="rounded bg-blue-1 px-6">
                {buttonIcon && <Image src={buttonIcon} alt="feature" width={20} height={20} />} &nbsp; {buttonText}
              </Button>
              <Button
                onClick={() => {
